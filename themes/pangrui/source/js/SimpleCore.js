 ...
 */
var SimpleCore = {
    buildingTime: new Date("2011-07-05"),
    current: null,
    prevTop: 0,
    headerShow: true,
    snsQRCode: null,
    ...
    init: function (params) {
        ...
        $(document).on('click', '.btn-sns-qr', function (e) {
            ...
            if (SimpleCore.snsQRCode != '') {
                SimpleCore.alert('高山流水，江湖再见','<img style="width:180px;background:#fff;" src="' + SimpleCore.snsQRCode + '">');
            } else {
    ...
    changeReadModel: function () {
        ...
        if (SimpleCore.getLocalData('read-mode') == 'night') {
            ...
            $(".cover-img").css({
                ...
                'background-image': 'http://ruizhengyun.cn/blog/images/cover-night.jpg',
            ...
            $(".cover-img").css({
                'background': "url('http://ruizhengyun.cn/blog/images/cover-day.jpg')",
                'background-image': 'http://ruizhengyun.cn/blog/images/cover-day.jpg',
                'background-size': 'cover',
                'background-position': 'center',
                'background-repeat': 'no-repeat'
            });
