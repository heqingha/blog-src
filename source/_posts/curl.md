...
categories: 编程
keywords: curl命令
description: 介绍常用curl命令，便于查找和使用
photos: /img/pangrui.jpg
abbrlink: a3d2b473
date: 2018-09-21 15:27:50
tags:
---

## 是个什么东西？

**curl命令** 是一个利用URL规则在命令行下工作的文件传输工具。它支持文件的**上传和下载**，所以是综合传输工具，但按传统，习惯称curl为下载工具。

作为一款强力工具，curl支持包括**HTTP、HTTPS、ftp**等众多协议，还支持**POST、cookies、认证、从指定偏移处下载部分文件、用户代理字符串、限速、文件大小、进度条**等特征。
